            ...
            public void onClick(View view) {
                if (vehid.getText().toString().isEmpty() || spot.getText().toString().isEmpty() || hours.getText().toString().isEmpty() || UPI.getText().toString().isEmpty()) {
                    ...
                    if(spots.contains(spot.getText().toString())){
                        ...
                        fStore.collection("Slot2").document(CurrentUser).set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {

                                if(task.isSuccessful()){

                                    Toast.makeText(booking2.this, "Booked", Toast.LENGTH_LONG).show();
                                    String spotS =spot.getText().toString();
                                    String hoursS = hours.getText().toString();
                                    Intent ii=new Intent(booking2.this, Qrcode.class);
                                    ...
                                    Toast.makeText(booking2.this, "(FIRESTORE Error) : " + error, Toast.LENGTH_LONG).show();

                                }

                            }
                        });
                        Toast.makeText(booking2.this,"Booking Confirmed",Toast.LENGTH_SHORT).show();
